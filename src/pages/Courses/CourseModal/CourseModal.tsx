		...
		<Modal open={isOpenModal} onClose={handleClose}>
			<CourseModalBox>
				<ModalHeader>
					...
					<img src={course?.image} style={{width: '100%', height:'auto', maxWidth:'20rem', objectPosition:'center'}} alt="course" />					
				</ModalHeader>
				<ModalBody>
					<Typography sx={{ mt: 2 }}>
					...
					<Button variant={'contained'} onClick={()=> navigate(`/courses/${course ? course.id : 1}`)}>Start this course</Button>
				</ModalBody>
			</CourseModalBox>
		</Modal>
	)
